 ...
 * @class abTrajectory
 *
 * @brief start Proxy Server
 *
 * Proxy Server is started to connect the Client
 */
public class abTrajectory {
    ...
    public abTrajectory() {
		...
		CustomLogger.info("Server started on port: " + server.getPort());

		CustomLogger.info("Waiting for client to connect");
    ...
    /**
     *
     * @brief do Screenshot and devolves it to the Server
     */
     ...
     * @brief Mainfunction
     *
     * set a new Game Extractor
     * calculate the dimensions of the screenshot
     * searching for the birds
     * searching fot the slingshot and return the result via the shell
     * draw bounding boxes around the slingshot and the birds
     * find active bird and plot the trajectory of the bird
     *
     */
    public static void main(String args[]) {
        ...
        while (true) {
            ...
            CustomLogger.info("captured image of size " + nWidth + "-by-" + nHeight);
             ...
             * @brief
             *
             * opens the vision class
             * searching for the birds that are given in the level
             * searching for the slingshot             *
             *
             */
            ...
            if (sling == null) {
                CustomLogger.severe("...could not find the slingshot");
                continue;
            }
           // CustomLogger.info("...found " + pigs.size() + " pigs and " + redBirds.size() + " birds");
            CustomLogger.info("...found slingshot at " + sling.toString());
             ...
             * draw BoundingBoxes in the screenshot around the redBirds and the sling
             * Searching for the active Bird
             * PLOTTRAJECTORY NOCH UNKLAR
             */
            ...
            if (activeBird == null) {
                CustomLogger.warning("...could not find active bird");
                continue;
            }
