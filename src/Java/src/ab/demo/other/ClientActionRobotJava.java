...
public class ClientActionRobotJava extends ClientActionRobot {
	...
	public byte[] shootSafe(int fx, int fy, int dx, int dy, int t1, int t2, boolean polar) {
	...
	public byte[] shootFast(int fx, int fy, int dx, int dy, int t1, int t2, boolean polar) {
