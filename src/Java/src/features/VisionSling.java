...
//	static private VisualDebugger DBG = new VisualDebugger("VisionSling :: Slingshot");
	...
	public Rectangle findSlingshot() {
		...
		CustomLogger.info(coarse.toString());
		Rectangle clip = null;
		...
		if (Math.abs(sling.height - h) > 7) {
			CustomLogger.info("previous slingshot height was " + sling.height
