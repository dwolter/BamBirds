...
public class Target {
	...
	public Target(String target, int angle, String debugInfo, double confidence, ThinkerType thinker) {
	...
	public String prettyPrint() {
		return String.format("Target: %7s @ angle %3s  DebugInfo: %-20s Confidence: %1.4f",
