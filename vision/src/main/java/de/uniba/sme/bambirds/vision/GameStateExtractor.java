...
public class GameStateExtractor {
	private static final Logger log = LogManager.getLogger(GameStateExtractor.class);
	...
	public static int getScoreInGame(BufferedImage screenshot) {
		...
		for (int i = 0; i < letters.length; i++) {
			...
			// CustomLogger.info(i + " : " + letters[i] + " : " + letterHash +
			// " : " + value);
		}            
	...
	public static int getScoreEndGame(BufferedImage screenshot) {
		...
		BufferedImage[] endGameNumberTemplates = { extractNumber(_endGame0), extractNumber(_endGame1),
				extractNumber(_endGame2), extractNumber(_endGame3), extractNumber(_endGame4), extractNumber(_endGame5),
				extractNumber(_endGame6), extractNumber(_endGame7), extractNumber(_endGame8), extractNumber(_endGame9) };
