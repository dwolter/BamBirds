...
def train_linear_model(features_training, labels_training):
    pipeline = PMMLPipeline([("linear_model", sklLM.LinearRegression())])
...
"""
def evaluate(lm_pipeline: PMMLPipeline, labels_predicted, labels_testing, features_testing, debug=False):
    lmreg = lm_pipeline.named_steps.get('linear_model')
