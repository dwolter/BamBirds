...
public class DecisionTreeRegressorModel implements RegressorModel {
	private static final Logger log = LogManager.getLogger(DecisionTreeRegressorModel.class);
	...
	public DecisionTreeRegressorModel() {
		...
		InputStream pmml_file_stream = getClass().getClassLoader().getResourceAsStream("models/tree_regressor.pmml");
